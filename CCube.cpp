...
int main(int argc, char **argv)
{
	...
	/*
	   for(int i=0; i<16; i++){
	   cout<<setw(3)<<cube1.corners[i].id
	   <<setw(5)<<cube1.corners[i].value
	   <<setw(5)<<cube1.corners[i].pos.t
	   <<setw(5)<<cube1.corners[i].pos.x
	   <<setw(5)<<cube1.corners[i].pos.y
	   <<setw(5)<<cube1.corners[i].pos.z
	   <<endl;
	   }
	   cout<<endl;

	   for(int l=0; l<32; l++){
	   cout<<setw(3)<<cube1.edges[l].id
	   <<setw(5)<<cube1.edges[l].lc.pos.t
	   <<setw(5)<<cube1.edges[l].lc.pos.x
	   <<setw(5)<<cube1.edges[l].lc.pos.y
	   <<setw(5)<<cube1.edges[l].lc.pos.z
	   <<" ---------- "
	   <<setw(5)<<cube1.edges[l].rc.pos.t
	   <<setw(5)<<cube1.edges[l].rc.pos.x
	   <<setw(5)<<cube1.edges[l].rc.pos.y
	   <<setw(5)<<cube1.edges[l].rc.pos.z
	   <<" ---MP--- "
	   <<setw(5)<<cube1.edges[l].MiddlePoint().t
	   <<setw(5)<<cube1.edges[l].MiddlePoint().x
	   <<setw(5)<<cube1.edges[l].MiddlePoint().y
	   <<setw(5)<<cube1.edges[l].MiddlePoint().z
	   <<endl;
	   }
	   ...
	   cout<<setw(3)<<0;
	   for(int i=0; i<32; i++)cout<<setw(3)<<i;
	   cout<<endl;

	   for(int i=0; i<32; i++){
	   cout<<setw(3)<<i;
	   for(int j=0; j<32; j++){
	   cout<<setw(3)<<cube1.Ibit[i][j];
	   }
	   cout<<endl;
	   }
	 */
	cout<<endl;
	for(int i=0; i<cube1.Nints; i++){
		cout<<"ints["<<i<<"].IEdge="<<cube1.ints[i].IEdge<<endl;
		cout<<"ints["<<i<<"].pos  ="<<setw(6)<<cube1.ints[i].pos.t
			<<setw(6)<<cube1.ints[i].pos.x
			<<setw(6)<<cube1.ints[i].pos.y
			<<setw(6)<<cube1.ints[i].pos.z
			<<endl;
	}

	//	cube1.OrderInts();
	double da0, da1, da2, da3;
	cube1.CalcSF2(da0,da1,da2,da3);

	cout<<endl;
	cout<<"DA0="<<da0<<" DA1="<<da1<<" DA2="<<da2<<" DA3="<<da3<<endl;
	cout<<"MassCenter= "; cube1.MassCenter.printout();
	cout<<"Velocity= "; cube1.V.printout();
