...
#define	NUMPARTICLE	600 /*  size of array for storage of the particles */
//#define MAXINTV         130000 /* size of arry for Montecarlo numbers */
#define MAXINTV         20000000 /* size of arry for Montecarlo numbers */
#define MHALF           (MAXINTV/2)
#define NRY     41 /* size of arry for rapidity spectrum */
#define NPT		15 /* size of arry for storage of the pt-spectrum */
#define NPHI	48 /* size of arry for storage of the y-spectrum */
#define NPHI1		NPHI + 1 
...
struct par  {
	...
	int	stable;     /* defines whether this particle is considered
        ...
        int     npt;
        int     nphi;
	double  dNdyptdptdphi[NRY][NPT][NPHI];   //changed by plg 02/16/2011
...
double  RY[NRY];    /* Array for rapidity-storage */
